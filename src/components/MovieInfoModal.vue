    ...
    <div class="movie-info-content">
      <BRow>
        ...
        <BCol sm="8">
          ...
          <div class="mt-3 mb-4">
            <BBadge variant="success" class="mr-2">{{ movieInfo.Year }}</BBadge>
            <BBadge variant="success" class="mr-2">{{ movieInfo.Runtime }}</BBadge>
            <BBadge variant="success" class="mr-2">{{ movieInfo.Genre }}</BBadge>
            <BBadge variant="success" class="mr-2">{{ movieInfo.Language }}</BBadge>
          </div>
...
export default {
  ...
  computed: {
    ...
    posterBg() {
      return this.movieInfo ? `url(${this.movieInfo.Poster})` : this.defaultPosterBg;
    }
  },
  methods: {
    closeModal() {
